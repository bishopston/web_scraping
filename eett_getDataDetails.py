...
url = requests.post("https://keraies.eett.gr/getData.php", data={"municipality":"Πύδνας - Κολινδρού", "startPage": str(0)})
...
# print(pages)
    ...
    for i in range(pages):
        url = requests.post("https://keraies.eett.gr/getData.php", data={"municipality":"Πύδνας - Κολινδρού", "startPage": str(i*25)})
        soup = BeautifulSoup(url.text, 'html.parser')
