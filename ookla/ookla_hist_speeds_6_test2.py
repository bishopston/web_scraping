...
df_empty_urls = pd.DataFrame(empty_urls)
...
df.to_csv(
    "/home/alexandros/Python/web_scraping/ookla/hist_results/mar24/hist_speeds_mar24_35-36_test5.csv",
    index=None,
    sep="|",
    header=False,
)
...
df_empty_urls.to_csv(
    "/home/alexandros/Python/web_scraping/ookla/hist_results/mar24/hist_speeds_mar24_35-36_test5_empty_urls.csv",
    index=None,
    sep="|",
    header=False,
)
print(df_empty_urls.head())